google.maps.__gjsload__('marker', function(_) {
    var zWa = function(a, b) {
        ...
        DWa = function(a, b) {
            b = (a = a.__e3_) && a[b];
            return !!b && Object.values(b).some(c => c.ZB)
        },
        EWa = function(a, b, c) {
        ...
        SWa = function(a, b, c = !1) {
            if (!b.get("internalMarker")) {
                ...
                RWa(b) && (_.Sk(a, "Mocb"), _.Q(a, 149062));
        ...
        aXa = function(a, b) {
            var c = 1,
                d = a.animation;
            var e = d.frames[OWa(d, b)];
            var f;
            d = a.animation;
            (f = d.frames[OWa(d, b) + 1]) && (c = (b - e.time) / (f.time - e.time));
            b = nO(a.element);
            d = a.element;
            f ? (c = (0, $Wa[e.pm || "linear"])(c), e = e.translate, f = f.translate, c = new _.Zk(Math.round(c * f[0] - c * e[0] + e[0]), Math.round(c * f[1] - c * e[1] + e[1]))) : c = new _.Zk(e.translate[0], e.translate[1]);
            c = d.__gm_at = c;
            d = c.x - b.x;
            b = c.y - b.y;
        ...
        dXa = function(a, b, c) {
            ...
            var e;
            if (e =
                c.oG !== !1) e = _.Om(), e = e.Eg.Mg || e.Eg.Kg && _.Js(e.Eg.version, 7);
            e ? d = new bXa(a, b, c) : d = new cXa(a, b, c);
            d.start();
            return d
        },
        qO = function(a) {
        ...
        jXa = function(a) {
            ...
            if (b) {
                if (!a.Jg) {
                    const e = a.Jg = new gXa(a.getPanes(), b, a.get("opacity"), a.get("visible"), a.vi);
        ...
        lXa = function(a) {
            if (!a.Vg) {
                ...
                if (b = kXa[b]) {
                    var c = b.options;
                    a.Eg && (a.Vg = !0, a.set("animating", !0), b = dXa(a.Eg, b.icon, c), a.Gg =
        ...
        rO = function(a, b, c, d, e) {
            if (hO(d)) a = mXa(a, b, c, d);
            else if (d.url != null) {
                const f = d.origin || _.ml;
                a = a.get("opacity");
                const g = _.bj(a, 1);
                c ? (c.firstChild.__src__ != d.url &&
                    _.YH(c.firstChild, d.url), _.$H(c, d.size, f, d.scaledSize), c.firstChild.style.opacity = `${g}`) : (e = e || {}, e.Zz = !_.Mm.Lg, e.alpha = !0, e.opacity = a, c = _.ZH(d.url, null, f, d.size, null, d.scaledSize, e), _.DF(c), b.appendChild(c));
                a = c
        ...
        qXa = function(a, b) {
            if (a.Ig) {
                ...
                for (const e of pXa) c.push(FWa(d, e, () => {
                    vO(a, b)
                })), c.push(EWa(d, e, () => {
                    !oXa(d) && b.xm && vO(a, b)
                }))
        ...
        yXa = function(a) {
            a.Kg.push(_.Vj(a.Eg, "dragging_changed", () => {
                if (a.Eg.get("dragging")) a.Rg = a.Jg.en(), a.Rg && _.cJ(a.Jg, a.Rg);
                    ...
                    if (b && (b = _.Nl(b, a.Fg.get("projection")), b = xXa(a, b))) {
        ...
        BXa = function(a) {
            if (a.Gg) {
                const b = new AXa(a.Fg instanceof _.jl);
        ...
        CXa = function(a, b, c, d, e = !1) {
            const f = new Map,
                g = h => {
                    ...
                    !a.contains(h) || !l && h.get("mapOnly") || p || (b instanceof _.Ck ? (l = b.__gm, h.__gm.Lq.map = new EXa(h, b, c, _.UI(l, h), d, l.Sg, f)) : h.__gm.Lq.streetView = new EXa(h, b, c, _.Xg, null, null, null), SWa(b, h, e))
                };
            _.Vj(a, "insert", g);
            _.Vj(a, "remove", g);
            a.forEach(g)
            ...
            if (c.dx > a || c.dy > b || c.dx + c.nq < a || c.dy + c.kq < b) a = !1;
                ...
                switch (d.type.toLowerCase()) {
                    ...
                    case "circle":
                        ...
                        break a;
                    default:
                        d = c, c = d.length, d[0] == d[c - 2] && d[1] == d[c - 1] || d.push(d[0], d[1]), a = _.iHa(a, b, d) != 0
                }
            }
            return a
        },
        yO = function(a, b, c, d) {
            ...
            c = null;
            for (e = 0; d = g[e]; ++e)
                if (f = d.Ev, f.clickable !== !1 && (f = f.Qz, IXa(a.x, a.y, d))) {
                    c = f;
                    break
                }
            c && (b.mj = d);
        ...
        KXa = function(a, b) {
            if (!b.MA) {
                ...
                for (let f = 0, g = d.length; f < g; ++f) {
                    var e = d[f];
                    const h = e.dk || null;
                    if (e = JXa(a, h, e.iG || null, b, c)) b.Ji[_.jk(e)] =
                        e, _.Cm(h.Ji, e)
                }
            }
        },
        LXa = function(a, b) {
            b.MA && (b.MA = !1, a.Ig.contains(b) ? a.Ig.remove(b) : a.Jg.remove({
                oi: b.oi,
                marker: b
            }), _.Si(b.Ji, (c, d) => {
                delete b.Ji[c];
        ...
        JXa = function(a, b, c, d, e) {
            ...
            e = a.Fg.size;
            a = _.DCa(a.Fg, new _.gm(c.x, c.y), new _.gm(f.x, f.y), b.zoom);
            c.x = a.sh * e.hh;
            c.y = a.th * e.jh;
            a = d.zIndex;
            _.$i(a) || (a = c.y);
        ...
        OXa = function(a, b, c) {
            a.Ig++ < 4 ? c ? a.Fg.gD(b) : a.Fg.IL(b) : a.Eg = !0;
        ...
        VXa = function(a, b, c) {
            ...
            const n = _.gHa(a, (x, y) => x.marker === y.marker);
            let p = null,
                r = null;
            const u = new _.hl(null),
                w = b.__gm;
            w.Fg.then(x => {
                w.Kg.register(new SXa(h, w, u, x.ah.tj));
                _.Bs(x.sr, y => {
                    if (y && p !== y.Bh) {
                        r && r.unbindAll();
                        var B = p = y.Bh;
                        r = new TXa(h, d, e, function(D, G) {
                            return new UXa(G, new AO(D, G, g, B), D)
                        }, l, n, p);
        ...
        XXa = function(a) {
            a.bo ||
                (a.bo = _.yF(() => {
                    ...
                    a.Pu = {};
                    const c = a.Uv;
                    for (const d of Object.values(b)) WXa(a, d);
                    c && !a.Uv && a.nt.forEach(d => {
                        WXa(a, d)
                    })
                }))
        },
        WXa = function(a, b) {
            ...
            b.changed = a.cL;
            if (!b.get("animating"))
                if (a.eC.remove(b), !c || b.get("visible") == 0 || b.__gm && b.__gm.Ln) a.nt.remove(b);
                else {
                    a.Uv && !a.lE && a.nt.getSize() >= 256 && (a.Uv = !1);
                    c = b.get("optimized");
                    ...
                    a.lE || c == 0 || e || f || g || d || h || !c && a.Uv ? _.Cm(a.nt, b) : (a.nt.remove(b), _.Cm(a.eC, b))
                }
        },
        YXa = function(a, b) {
            const c = new _.nm;
                ...
                () => {
                    if (a.map) {
                        ...
                        for (const d of a.Jg) {
                            ...
                            const f = d.Ln !== !1 && BO(d) || d.uv,
                                g = _.Dk(a.map);
                            g || (a.Mg || (a.Mg = a.Fg.attachShadow({
                                mode: _.Km[166] ? "open" : "closed"
                            }), a.Mg.append(a.Kg, a.Eg)), a.Fg.append(e));
                            g && e.parentElement === g || !g && e.parentElement === a.Fg ? e.setAttribute("slot", f ? $Xa : aYa) : e.style.visibility = f ? "hidden" : "";
                            d.Wl(!f);
                            d.Gv = !1
                        }
                        a.Jg.clear();
        ...
        jYa = function(a) {
            ...
            if (!(c = b.dragIndicator)) {
                if (!b.Mu) {
                    ...
                    b.Mu = new Image(e.width, e.height);
                    b.Mu.src = d;
                    b.Mu.alt = ""
                }
                c = b.Mu
        ...
        HO = function(a, b, c) {
            _.hk(a, b, new _.Nz(a.Oo, c, a.zv ? new _.Zk(a.zv.hh, a.zv.jh) : null))
        },
        JO = function(a) {
            _.hk(a, "REMOVE_COLLISION")
        },
        tYa = function(a) {
            a.element.style.cursor = a.Mi ? lYa(a.Mi, a.rv) : a.rv ? "pointer" : ""
        },
        LO = function(a, b = !1) {
            BO(a) && (a.Fh && BWa(a.Fh.Vg,
                a), _.hk(a, "UPDATE_MARKER_COLLISION"), b && a.zw && _.hk(a, "UPDATE_BASEMAP_COLLISION"))
        },
        uYa = function(a) {
            a.Yq.then(() => {
        ...
        MO = function(a) {
            a.style.pointerEvents = a.Mx ? "none" : a.QE ? "auto" : ""
        },
        NO = function(a) {
            a.xm = a.rv || !!a.hu
        },
        ...
        wYa = function(a) {
            !a.Xj && a.map && a.Fh && (a.YB = !0, a.Xj = _.Qv(a.element, {
                    Ql: ({
                        event: b,
                        Aq: c
                    }) => {
                        a.QE ? (_.Vt(b.Eg), b.button === 3 || c || vYa(a, b.Eg)) : a.element === b.Eg.target || a.Mx || (console.debug('To make AdvancedMarkerElement clickable and provide better accessible experiences, use addListener() to register a "click" event on the AdvancedMarkerElement instance.'), a.Wi.Og(a.map))
                    }
                }), a.aA = _.qma({
                    draggable: a.CE,
                    QD: new _.eA(a.map, "gestureHandling"),
                    rk: a.Fh.pl
                }),
                _.Bs(a.aA, a.pE), a.YB = !1)
        },
        PO = function(a) {
        ...
        zYa = function(a) {
            ...
            a.zw = a.SE && !b;
            if (!a.xp || a.position) a.zw ? fYa(a.map) : yYa(a)
        },
        AYa = function(a) {
            if (!a.xp) {
                var b = a.Fh.Eg;
        ...
        yYa = function(a) {
            var b = LWa(a.Jj, a.Oo);
            a.Hj ? a.Hj.setPosition(b, a.Vk()) : a.ah && (b = new _.cK(a.ah.tj, a, b, a.ah, null, a.Vk(), a.nJ), a.ah.Li(b), a.Hj = b)
        };
    _.Zk.prototype.Ux = _.da(17, function() {
        return Math.sqrt(this.x * this.x + this.y * this.y)
    });
    var pXa = ["click", "dblclick", "rightclick", "contextmenu"],
        CYa = {
            DEFAULT: "DEFAULT",
            qO: "PIN",
            rO: "PINLET"
        },
        DYa = class extends _.kk {
            constructor() {
                super();
                this.constraint = 0;
                this.Eg = !1
    ...
    var gO = class extends _.yq {
        constructor(a = {}) {
            ...
            this.shape = this.mh("shape", _.Bj(_.uj(CYa)), a.shape) || "DEFAULT";
            _.Il(this, "shape");
            let b, c;
            switch (this.shape) {
                case "PIN":
        ...
        set glyphColor(a) {
            ...
            this.Pg !== a && (this.Pg = a, QWa(this), fO(this), this.Pg == null || this.Pg === this.Yg ? (_.Sk(window, "Pdgc"), _.Q(window, 160669)) : (_.Sk(window, "Pcgc"), _.Q(window, 160670)))
        }
        get scale() {
            return this.Ig
        }
    ...
    var FYa = class extends _.kk {
            ...
            Gg() {
                ...
                VWa(this, "viewIcon", a || b && XO.Fg || XO.icon);
                VWa(this, "viewCross", XO.Eg);
    ...
    var bXa = class {
        ...
        start() {
            ...
            YWa(this.element, PWa(this.animation), this.options)
        }
        cancel() {
            this.Eg && (this.Eg.remove(), this.Eg = null);
            YWa(this.element, null, {});
            _.hk(this, "done")
        }
        stop() {
    ...
    var lO = [],
        ...
        cXa = class {
            ...
            start() {
                lO.push(this);
                mO || (mO = window.setInterval(ZWa, 10));
                this.startTime = Date.now();
                this.tick()
            }
            cancel() {
                this.Eg || (this.Eg = !0, aXa(this, 1), _.hk(this, "done"))
            }
            stop() {
                this.Eg || (this.im = 1)
            }
    ...
    var HYa = _.ka.DEF_DEBUG_MARKERS,
        YO = class extends _.kk {
                ...
                this.Lg = new _.xm(() => {
                        ...
                        if (!d || !this.getPosition() || this.Ei() == 0 || _.$i(e) && e < .1 && !this.Ek) qO(this);
                            ...
                            if (!this.Qg) {
                                ...
                                if (f) {
                                    ...
                                    if (e || h || n) {
                                        ...
                                        HYa && (y.dataset.debugMarkerImage = g);
                                        y = B || y;
                                        y.title = l;
                                        n && this.rp().setAttribute("aria-label", n);
                                        this.gw();
                                        h && !this.Kg && (g = this.Kg = new _.gJa(y, this.Ug, this.targetElement), this.Ug ?
                            ...
                            for (e = 0; e < this.Mg.length; ++e)
                                if (h = this.Mg[e]) d = h, g = h.Mg, l = nO(h) || _.ml, h = sO(this), g = hXa(this, g, h, l), _.mu(d, g), (g = _.Om().transform) && (d.style[g] = h != 1 ? "scale(" + h + ") " : ""), d && _.ou(d, iXa(this));
                            lXa(this);
            ...
            animation_changed() {
                this.Vg = !1;
                this.get("animation") ? lXa(this) : (this.set("animating", !1), this.Gg && this.Gg.stop())
            }
            PE(a) {
                const b = this.get("markerPosition");
                return this.mp && b && this.mp.size ? TWa(a, this.targetElement) : !1
            }
        };
    _.H = YO.prototype;
    ...
    var tXa = "click dblclick mouseup mousedown mouseover mouseout rightclick dragstart drag dragend contextmenu".split(" "),
        EXa = class {
            constructor(a, b, c, d, e, f, g) {
                ...
                this.Sg && this.Ig && !this.Ig.has(this.Eg) && (this.Ig.set(this.Eg, {
                    marker: this.marker,
                    kE: []
                }), this.Sg.Pg(this.Eg), vO(this, this.Eg), qXa(this, this.Eg));
                ...
                sXa(this);
                uXa(this);
                this.Og ? (vXa(this), wXa(this), yXa(this)) : (zXa(this), this.Gg && (this.Mg.bindTo("visible", this.marker), this.Mg.bindTo("cursor", this.marker), this.Mg.bindTo("icon", this.marker), this.Mg.bindTo("icon", this.Lg, "viewIcon"), this.Mg.bindTo("mapPixelBoundsQ",
                    this.Fg.__gm, "pixelBoundsQ"), this.Mg.bindTo("position", this.Gg, "pixelPosition"), this.Eg.bindTo("visible", this.Mg, "shouldRender")), BXa(this))
            }
            dispose() {
    ...
    AO.prototype.IL = AO.prototype.gD;
    var QXa = class {
        constructor() {
            this.Eg = _.wF().Eg
        }
    ...
    var SXa = class {
        ...
        handleEvent(a, b, c) {
            ...
            let f;
            d && a !== "mouseout" ? f = d.Ev.latLng : f = b.latLng;
            a ===
                "dblclick" && _.Tj(b.domEvent);
            _.hk(c, a, new _.Nz(f, b.domEvent))
        }
    };
    var TXa = class extends _.qo {
        constructor(a, b, c, d, e, f, g) {
            super();
            this.Kg = a;
            this.Mg = d;
    ...
    var RXa = class {
        ...
        Gq(a) {
            ...
            const f = a.get("shape") || c && !b ? a.get("shape") : this.Eg.shape,
                ...
                h = GWa(() => {
                    e === a.__gm.Ix && (e.Bt || e.cG) && this.tl(a, e, g, f)
                });
    ...
    var IYa = class {
        constructor(a, b, c, d) {
            ...
            this.cL = function(g) {
                g in f && (delete this.changed, e.Pu[_.jk(this)] = this, XXa(e))
            };
            a.Eg = g => {
                e.Gq(g)
            };
    ...
    var aYa = CWa("visible-gmp-advanced-markers"),
        $Xa = CWa("hidden-gmp-advanced-markers"),
        dYa = class {
            constructor(a) {
                this.Wi = LYa;
                this.oo = null;
                ...
                this.Gg.id = this.tm;
                this.Gg.textContent = "Pressione as teclas Alt + Enter para ativar o recurso de arrastar com o teclado. Depois disso, use as teclas de seta para mover o marcador. Pressione a tecla Enter quando quiser parar de arrastar. Para cancelar, pressione Esc.";
                ...
                this.Pg = new Promise(d => {
                    c.Gg.then(e => {
                        this.map && (e && (this.oo = YXa(this, a)), this.Og = !0);
                        d()
                    })
                });
                _.$q(KYa, this.map.getDiv());
    ...
    var NYa = class {
        constructor(a) {
            ...
            this.Tg = b => {
                if (this.Jg || this.Mg || MWa(b, this.Xg)) this.Mg = !0
            };
            a = this.Eg.Co;
            ...
            this.Sg = b => {
                b.preventDefault();
                b.stopImmediatePropagation();
                this.Jg ? oYa(this, b) : this.Ig ? (pYa(this, b), HO(this.Eg, "drag", b)) : (qYa(this, b), b = this.Eg, b.Wi.Vg(b.map))
            };
            this.Lg = b => {
                this.Ng && b.timeStamp - this.Ng >= 500 && (!this.Ig || this.Jg) ? (this.Jg ? oYa(this, b) : (qYa(this, b), b = this.Eg, b.Wi.Tg(b.map), b.xp && _.hk(b, "longpressdragstart")), this.Mg = !0) : (this.Ig && (this.Jg || this.Mg || MWa(b, this.Xg)) && (this.Mg = !0), this.Jg && EO(this, b), b.type === "touchend" && (this.Fg.style.display =
                    "none"), this.Ig ? (b.stopImmediatePropagation(), pYa(this, b), KO(this), LO(this.Eg, !0), HO(this.Eg, "dragend", b)) : KO(this))
            };
            this.lh = b => {
                this.yh(b)
            };
            ...
            this.yh = b => {
                ...
                else if (_.Ox(b) || _.Qx(b) || _.Px(b) || _.Rx(b)) b.preventDefault(), this.Rg.add(b.key), this.Pg || (this.Wg = new _.YI(100), sYa(this)), HO(this.Eg, "drag", b);
                else if (b.code === "Equal" || b.code === "Minus") {
                    var c = this.Eg;
                    b = b.code === "Equal" ? 1 : -1;
                    const d = LWa(c.Jj, c.Oo);
                    d && c.ah.GG(b, d)
                }
            };
            this.rh = b => {
    ...
    var ZO = !1,
        $O = class extends _.yq {
            constructor(a = {}) {
                super(a);
                this.Mu = this.Xj = this.Mi = null;
                this.Mz = "";
                this.Hk = this.zv = this.Rp = this.ah = this.Hj = this.Ok = null;
                this.GC = !1;
                this.Iy = null;
                this.wB = this.SE = this.Jy = this.IC = !1;
                this.Fh = this.zw = this.hF = this.DF = this.HG = this.wD = null;
                this.FC = void 0;
                this.hu = this.HC = !1;
                this.CE = _.il(!1);
                this.Oo = this.iu = this.aA = null;
                this.br = "";
                ...
                this.DD = getComputedStyle(this.element);
                this.nJ = (e, f, g) => this.sx(e, f, g);
                const b = () => {
                        MO(this);
                        NO(this);
                    ...
                    d = ["click"];
                d.push("gmp-click");
                for (const e of d) FWa(this, e, b), EWa(this, e, c);
                this.yq = new _.kk;
                this.pE = e => {
            ...
            addEventListener(a, b, c) {
                a !== "click" || this.YB || _.Pj(_.Jl(this, "Please use addEventListener('gmp-click', ...) instead of addEventListener('click', ...)."));
            ...
            set collisionBehavior(a) {
                ...
                this.collisionBehavior !== a && (this.FC = a, this.Wi.Gg(this.map, this.FC), this.map && (!BO(this) && this.Fh ? AWa(this.Fh.Vg, this) : LO(this, !0)))
            }
            get element() {
                return this
            }
            ...
            set gmpClickable(a) {
                ...
                this.HC !== a && (this.HC = a, MO(this), NO(this))
            }
            get gmpDraggable() {
                return this.hu
            }
            set gmpDraggable(a) {
                ...
                xYa(this, this.position, a);
                this.CE.set(a);
                this.hu !== a && ((this.hu = a) ? (this.Wi.Jg(this.map), this.element.setAttribute("aria-grabbed", "false"), this.Kw(this.Mz), this.Mi = new NYa(this), jYa(this.Mi)) : (this.element.removeAttribute("aria-grabbed"),
                    this.by(this.Mz), this.Mi.dispose(), this.Mi = null), MO(this), NO(this))
            }
            Kw(a) {
                this.Mz = a;
                if (this.hu) {
            ...
            setMap(a) {
                this.Jj !== a && (a = this.mh("map", _.Bj(_.tj(_.Ck, "MapsApiMap")), a), a instanceof _.Ck && (a = a.gM), a && this.element.isConnected ? QO(this) : this.dispose(), this.Jj = a, this.yq.set("map", this.Jj), this.Jj instanceof _.Ck ? (this.Jj && eYa(this, this.Jj), this.Fh = this.Jj.__gm, wYa(this), this.wD = this.Jj.addListener("bounds_changed", () => {
                    RO(this)
                }), this.HG = this.Jj.addListener("zoom_changed", () => {
                    RO(this)
                }), this.DF = this.Jj.addListener("projection_changed",
                    () => {
                        RO(this)
                    }), this.hF = this.Jj.addListener("maptypeid_changed", () => {
                    zYa(this)
                }), Promise.all([this.Fh.Fg, this.Fh.Gg]).then(([b, c]) => {
                    this.Jj === b.map && (this.SE = c, this.Wi.Rg(b.map), c = this.Fh.Eg, this.xp || _.jm(c, "ADVANCED_MARKERS").isAvailable) && (this.ah = b.ah, zYa(this))
                }), AYa(this), BYa(this)) : this.Fh = null)
            }
            get position() {
                return this.iu
            }
            set position(a) {
                ...
                const b = this.iu;
                xYa(this, a, this.gmpDraggable);
                if (b && a) {
                    var c = new _.Qp(b, !0);
                    const d = new _.Qp(a, !0);
                    c = !c.equals(d)
                } else c = b !== a;
                c && (this.Oo = (this.iu = a) ? new _.Hj(a) : null, this.wB = !0, a || SO(this, null), this.yq.set("position", this.Oo), this.zw ? fYa(this.map) : yYa(this), this.Vk() > 0 && this.Wi.Eg(this.map), _.El(this, "position", b))
            }
            get sK() {
                return this.iu
            }
            ...
            set title(a) {
                ...
                a !== this.title && (this.br = a, this.title && this.Wi.Kg(this.map), this.title === "" ? (this.element.removeAttribute("aria-label"), this.element.removeAttribute("title")) : (this.element.setAttribute("aria-label",
                    this.title), this.element.setAttribute("title", this.title)), this.gw(), _.El(this, "title", b))
            }
            get zIndex() {
                return this.Ky
            }
            ...
            get QE() {
                return this.rv || !!this.gmpDraggable
            }
            get xm() {
                return this.GC
            }
            ...
            set uv(a) {
                if (a !== this.Jy) {
                    if (this.Jy = a) this.wz = this.xz = !1, JO(this);
                    this.map && gYa(this, this.map)
                }
            }
            get Ln() {
                return this.Iy
            ...
            set Ln(a) {
                a !== this.Iy && (this.Iy = a, this.map && gYa(this, this.map), RO(this), _.hk(this, "UPDATE_BASEMAP_COLLISION"))
            }
            hv() {
            ...
            sx(a, b, c) {
                return this.Jj ? (c = _.JFa(this.Jj.getProjection(), this.Oo, c)) ? a / c * Math.sin(b * Math.PI / 180) : 0 : 0
            }
            Yn(a, b, c) {
                if (a) {
                    if (this.Mi) {
                        b = this.Mi;
                        var d = b.Eg;
                        b = (d = d.Fh ? d.Fh.np : null) && b.Kg && b.Ig && !b.Jg ? KWa(d, b.Kg) : null
                    } else b = null;
                    b && (a = b);
                    this.zv = a;
                    this.uv = !(!c || !(Math.abs(a.hh) > c.hh / 2 + 512 || Math.abs(a.jh) > c.jh / 2 + 512));
                    this.uv || (this.Gv && this.map && (c = _.ra(this.map), (c = DO.get(c)) && bYa(c, this)), (new _.Zk(a.hh, a.jh)).equals(this.Rp) || (SO(this, new _.Zk(a.hh,
                        a.jh)), this.Gy(this.wB)), this.wB = !1, this.wz = this.xz = !0)
                } else this.uv = !0, this.zv = null, SO(this, null)
            }
            Gy(a) {
                this.Hk = null;
                this.Mi && this.Mi.Gg && this.Mi.Gy(this.hv());
                LO(this, a)
            }
            Wl(a) {
                this.IC !== a && (this.IC = a, this.yq.set("map", this.IC ? this.map : null))
            }
            yx() {
                ...
                for (const g of PO(this)) {
                    ...
                    const {
                        size: h,
                        offset: l
                    } = e;e = new EYa(a.x, a.y, h.width, h.height, l.x, l.y);b.push(e)
                }
                return b
            }
            rs() {}
            ...
            PE(a) {
                return !this.position || this.Iy ? !1 : TWa(a, this.element)
            }
            gw() {
                const a = this.rp();
            ...
            disconnectedCallback() {
                !this.isConnected && this.wz && (this.map = null);
                this.Gv = !0;
    ...
    var aP = {
        ...
        qz: function(a, b, c) {
            const d = _.BHa();
            if (b instanceof _.jl) DXa(a, b, d);
            else {
                const e = new _.Bm;
                DXa(e, b, d);
                const f = new _.Bm;
        ...
        connectForExplicitThirdPartyLoad: () => {
            ...
            OYa || (OYa = !0, _.ul("gmp-advanced-marker", $O))
        }
    };
    _.kj(aP, ["oI", "qz", "GD", "connectForExplicitThirdPartyLoad"]);
    _.jj(aP);
    _.Ki("marker", aP);
});